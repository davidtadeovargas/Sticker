...
//        let testImage1 = Data(contentsOf: forecastURL1 as! URL)
        
        
//        let testImage1 = NSData (contentsOf: forecastURL1! as URL)
//
//        self.imageData = testImage1
    ...
    init(contentsOfUrl filename: String, emojis: [String]?) throws {
        ...
        self.imageData = try ImageData.imageDataIfCompliant(rawData: testImage1, extensionType: ImageDataExtension.png, isTray: false)
        //
